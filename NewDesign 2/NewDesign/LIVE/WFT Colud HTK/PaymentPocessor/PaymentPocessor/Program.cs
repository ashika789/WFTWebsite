    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                SqlCommand Authorizecommand = new SqlCommand("pr_GetGroupOfTodaysPaymentItems", sqlConnection);
                ...
                SqlCommand PayPalcommand = new SqlCommand("pr_GetTodaysPaymentItems", sqlConnection);
            ...
            try
            {
                ...
                if (PaymentMethod.ToString() == "Authorize.net" || PaymentMethod.ToString() == "")
                {
                    ...
                    if (ReturnApproved == true)
                    {
                        ...
                        CustomerSubject = "WFT Cloud : Your Monthly Payment Notification";
                    }
                    else if (ReturnApproved == false)
                    {
                        ...
                        CustomerContent = "Your payment for the below subscribed service with WFT Cloud failed for the month of " + DateTime.Now.ToString("MMMM") + ". Pls. check with your CC company or update your Credit Card information within 24 hrs by logging into your account profile from WFT cloud website to avoid any interruption to your service. <br> Our system does not accept PIN based debit cards. We accept all Credit cards and Paypal.";
                        CustomerSubject = "WFT Cloud : Your  Payment failed for " + DateTime.Now.ToString("dd-MMM-yy") + "";
                    }
                    ...
                    string UserContent = UserEmailContent.Replace("++dear++", User.LastName + "," + User.FirstName)
                                       ...
                                       .Replace("++PaymentDetails++", PaymentDetailsMailContent);
                    SendEmail(UserContent, CustomerSubject , User.EmailID, false, true);

                    if (ReturnAuthMessage.Contains("The credit card has expired."))
                    {
                        string Serviceinfo = ("<table border='1'><tr><td rowspan='6'><strong>Subscription Information</strong></td>"
                                        + "<td><strong>Subscription ID </strong></td><td>" + res.UserSubscriptionID + "<br /></td></tr>"
                                        + "<tr><td><strong>User Name </strong></td><td>" + UserInfo.LastName + " " + UserInfo.FirstName + "<br /></td></tr>"
                                         + "<tr><td><strong>User Email </strong></td><td>" + UserInfo.EmailID +  "<br /></td></tr>"
                                        + "<tr><td><strong>Payment For </strong></td><td>" + "Subscription Renewal" + "<br /></td></tr>"
                        ...
                        UserEmailInfoContent = UserEmailInfoContent.Replace("%DomainName%", ConfigurationManager.AppSettings["DomainName"]);
                        ...
                        SendEmail(UserInfoContent, "Credit card has expired for Subsctipyion ID : "+ res.UserSubscriptionID +" ", User.EmailID, false, true);
                    }
