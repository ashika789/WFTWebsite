<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPages.Master" AutoEventWireup="true" CodeBehind="CustomServiceProvisioningDetails.aspx.cs" Inherits="WFTCloud.Admin.CustomServiceProvisioningDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>CustomServiceProvisioningDetails</title>
    ...
    <asp:MultiView ID="mvContainer" runat="server" ActiveViewIndex="0">
                ...
                <div class="span12">
                    <div class="row-fluid">
                        <div id="divSPDSuccessMessage" runat="server" visible="false" class="alert alert-block alert-success span6">
                            ...
                            <p>
                                <i class="icon-ok"></i>
                                Custom Service Provision Updated successfully.
                            </p>
                            </div>
                        </div>
                        <div class="row-fluid">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <div class="action-buttons">
                                                    <a data-rel="tooltip" title="Edit Service Provision" href='CustomServiceProvisioningDetails.aspx?editserviceprovisionid=<%# Eval("ServiceProvisionID")%>' class="green">
                                                        <i class="icon-pencil bigger-130"></i>
                                                    </a>
                                                    <a data-rel="tooltip" title="Activate/Deactivate" href='CustomServiceProvisioningDetails.aspx?<%# WFTCloud.GeneralReusableMethods.GetActivateDeactivateAction(Eval("RecordStatus").ToString()) %>=<%# Eval("ServiceProvisionID")%>' class="blue">
        ...
        <asp:View ID="SPUpdate" runat="server">
            <div class="row-fluid">
                ...
                <a href="CustomServiceProvisioningDetails.aspx">&lt;&lt; Back&nbsp;</a>
                <div class="table-header">
                    Edit Custom Service Provisioning Details
                </div>
                <table class="table table-hover dataTable table-bordered ">
                    ...
                    <tr>
                        <td class="span2">Choose Custom Service</td>
                        <td>
        ...
        <asp:View runat="server" ID="NewSP">
            <div class="row-fluid">
                ...
                <div id="divNewSuccess" runat="server" visible="false" class="alert alert-block alert-success span6">
                    ...
                    <p>
                        <i class="icon-ok"></i>
                        New Custom Service Provision added successfully.
                    </p>
                </div>
                ...
                <div class="table-header">
                    New Custom Service Provisioning Details
                </div>
                <table class="table table-hover dataTable table-bordered ">
                    <tr>
                        <td class="span4">Choose Category
