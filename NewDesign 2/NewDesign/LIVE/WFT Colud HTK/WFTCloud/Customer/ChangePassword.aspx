<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/CustomerPages.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="WFTCloud.Customer.ChangePassword" %>
                                    ...
                                    <div class="row-fluid">
                                        <div class="dataTables_wrapper">
                                            <table class="table table-hover dataTable table-bordered span9" id="tblChangePassword">
                                                <tr>
                                                    <td class="span4" style="vertical-align:top;">New Password</td>
                                                    <td class="span8">
