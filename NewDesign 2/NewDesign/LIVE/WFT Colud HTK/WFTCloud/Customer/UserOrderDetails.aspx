<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/CustomerPages.Master" AutoEventWireup="true" CodeBehind="UserOrderDetails.aspx.cs" Inherits="WFTCloud.Customer.UserOrderDetails" %>
                ...
                <div class="widget-header no-border">
                    <ul class="nav nav-tabs" id="Ul1">
                        <li id="liManage" runat="server" class="active">
                            <a href='/Customer/UserOrderDetails.aspx?userid=<%=UserMembershipID %>'>My Order Histroy</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div id="Manage" class="tab-pane in active" runat="server">
                                <asp:MultiView ID="mvOrderDetails" runat="server" ActiveViewIndex="0">
                                                                ...
                                                                <thead>
                                                                    <tr role="row">
                                                                       ...
                                                                       <%-- <th role="columnheader">Subscription ID</th>--%>
                                                                        ...
                                                                        <th role="columnheader" style="text-align: center;">View Details</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody role="alert">
                                                                    <asp:Repeater ID="rptrOrderHistroy" runat="server">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <%--<td><%# UserSubscriptionID(Eval("UserOrderID").ToString()) %>
                                                                                    <asp:HiddenField ID="hidUserSubscriptionID" runat="server" Value='<%# Eval("UserOrderID")%>' />
                                                                                </td>--%>
                                                                                ...
                                                                                <td><%# Eval("PaymentMethod")==null?"Authroize.net":Eval("PaymentMethod") %></td>
                                                                                <td><%# GetOrderStatus(Eval("UserOrderID").ToString()) %></td>
                                                                                <td style="text-align: center; vertical-align: middle;">
                                                                                    <a data-rel="tooltip" title="View Details" class="btn btn-primary btn-small" href='/Customer/UserOrderDetails.aspx?userid=<%=UserMembershipID %>&UserOrder=<%#Eval("UserOrderID") %>'>
                                    ...
                                    <asp:View ID="vmOrderDetails" runat="server">
                                        <h4><a href='/Customer/UserOrderDetails.aspx?userid=<%=UserMembershipID %>'><< Back</a></h4>
                                        <div class="table-header">
                                            <strong>Order Number :
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable">
                                              <tr>
                                                <td class="auto-style1">Subscription [ID]'s
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="auto-style1">Total Amount
                                                </td>
                                                <td>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTable">
                                            ...
                                            <tr>
                                                <td>Mode</td>
                                                <td>
                                                    <asp:Label runat="server" ID="lblMode"></asp:Label></td>
                                            </tr>
                                    ...
                                    <asp:View ID="vwNoOrderHistroy" runat="server">
                                        <div class="alert alert-warning" id="divNoCrmIssue" runat="server">
                                            ...
                                            <i class="icon-remove"></i><strong>No Orders Found</strong>
                                        </div>
                                    </asp:View>
                                </asp:MultiView>
                            </div>
