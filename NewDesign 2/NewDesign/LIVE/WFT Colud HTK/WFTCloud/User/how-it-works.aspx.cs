...
namespace WFTCloud.User
{
    public partial class how_it_works : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var Content = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "how-it-works.aspx" && c.Language == selectedLanguage);
            if (Content != null)
            {
            ...
            {
                var EnglishContent = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "how-it-works.aspx" && c.Language == "English");
