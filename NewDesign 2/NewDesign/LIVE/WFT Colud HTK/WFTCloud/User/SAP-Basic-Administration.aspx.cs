...
{
    public partial class SAP_Basic_Administration : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var Content = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "SAP-Basic-Administration.aspx" && c.Language == selectedLanguage);
            if (Content != null)
            {
            ...
            {
                var EnglishContent = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "SAP-Basic-Administration.aspx" && c.Language == "English");
