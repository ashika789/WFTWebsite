...
namespace WFTCloud.User
{
    public partial class saas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var Content = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "saas.aspx" && c.Language == selectedLanguage);
            if (Content != null)
            {
            ...
            {
                var EnglishContent = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "saas.aspx" && c.Language == "English");
