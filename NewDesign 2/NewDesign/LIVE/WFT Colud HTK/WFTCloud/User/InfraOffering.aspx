<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd.Master" AutoEventWireup="true" CodeBehind="InfraOffering.aspx.cs" Inherits="WFTCloud.User.InfraOffering" %>
                                    ...
                                    <tr>
                                        <td style="width: 50%;">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="width: 30%; vertical-align: top;">Your Company Name
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCompanyName" ValidationGroup="Register" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <td style="width: 30%; vertical-align: top;">Message
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Register" ControlToValidate="txtMessage" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtMessage" runat="server" CssClass="input-medium" TextMode="MultiLine" Height="50px" Width="310px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
