<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd.Master" AutoEventWireup="true" CodeBehind="SAP-Basic-Administration.aspx.cs" Inherits="WFTCloud.User.SAP_Basic_Administration" %>
...
<p class="split-para"><span style="float:left"><strong><a href="http://www.wftcloud.org" target="_blank">www.wftcloud.org</a></strong></span>
                            ...
                            <div class="span4">
                            	<h6>Other Links</h6>
                            	<ul class="otherlinks">
                                	<li><a href="/user/SAP-HANA-Administration.aspx">SAP HANA administration / migration online training</a></li>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="width: 30%; vertical-align: top;">First Name
                                                       <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ValidationGroup="Register" ControlToValidate="txtFirstName" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <br />
                                                        <asp:Button ID="btnRegisterCode" CssClass="btn btn-primary" ValidationGroup="Register" runat="server" Text="Register" OnClick="btnRegisterCode_Click"/>
                                                    </td>
                                                </tr>
                                            </table>
