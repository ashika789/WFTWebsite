...
{
    public partial class SAP_Cloud_computing : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var Content = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "SAP-Cloud-computing.aspx" && c.Language == selectedLanguage);
            if (Content != null)
            {
            ...
            {
                var EnglishContent = objDBContext.SitePagesAndContents.FirstOrDefault(c => c.PageRelativeUrl == "SAP-Cloud-computing.aspx" && c.Language == "English");
        ...
        protected void btnRegisterCode_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtComments.Text = txtContactNumber.Text = txtEmailID.Text = txtFirstName.Text = txtLastName.Text = txtMiddleName.Text = txtCity.Text = txtState.Text = txtCountry.Text = string.Empty;
