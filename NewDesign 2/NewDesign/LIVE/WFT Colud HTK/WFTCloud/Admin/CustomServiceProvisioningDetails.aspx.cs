...
{
    public partial class CustomServiceProvisioningDetails : System.Web.UI.Page
    {
        ...
        protected void ddlNewCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            bindDataToServices();
                ...
                else
                {
                    ...
                    lblNewError.Text = "All Custom Services in this category has provision details.";
        ...
        private void ShowPaginatedAndDeletedRecords()
        {
            try
            {
                ...
                {
                    rptrServiceProvision.DataSource = objDBContext.vwServiceProvisionDetails.Where(Ser => Ser.UserSpecific == true).OrderByDescending(obj => obj.ServiceProvisionID);
