<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPages.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="ManageCRMRequests.aspx.cs" Inherits="WFTCloud.Admin.ManageCRMRequests" %>
				...
				<div class="widget-header no-border">
					<ul class="nav nav-tabs" id="Ul1">
							<li id="liManage" runat="server">
								<a href="/Admin/ManageCRMRequests.aspx">Manage CRM Issues</a>
							</li>
						</ul>
				</div>
							...
							<div id="Manage" class="tab-pane active" runat="server">
                                <asp:MultiView ID="mvCrmIssues" runat="server" ActiveViewIndex="0">
                                                ...
                                                <div role="grid" class="dataTables_wrapper">
                                                    <table id="tblManageCrm" class="table table-striped table-bordered table-hover dataTable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><%# Eval("CreatedOn","{0:dd-MMM-yyyy}")%></td>
                                                            <td><%# Eval("CRMRequestStatusDesc") %></td>
                                                            <%--<td><%#Eval("AssignedEmailID")== null?"Not Yet Worked":Eval("AssignedEmailID") %></td>--%>
                                                            <td style="text-align:center;">
                                                                <div class="action-buttons">
                                                                <a data-rel="tooltip" title="View CRM Request" href="/Admin/ManageCRMRequests.aspx?crmrequestid=<%# Eval("CRMRequestID")%>" class="green">
                                    ...
                                    <asp:View ID="vmCRMForm" runat="server">
                                        <h5>
                                        <a href="/Admin/ManageCRMRequests.aspx">&lt; Back CRM Requests&nbsp;</a>
                                        </h5>
                                        <div class="table-header">
		                            Edit CRM Issues
	                            </div>
...
<%--                                    <tr runat="server" id="trAssignTo">
                                                    ...
                                                    <table id="Table1" class="table table-striped table-bordered table-hover dataTable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                <div class="action-buttons">
                                                                <a data-rel="tooltip" title="View CRM Request" href="/Admin/ManageCRMRequests.aspx?crmrequestid=<%#Eval("CRMRequestID")%>&Crmhistoryid=<%#Eval("CRMHistoryID")%>" class="green">
                                                                    <i class="icon-pencil bigger-130"></i>
                                                                </a>
                                                                </div>
                                                            </td>
                                    ...
                                    <asp:View ID="vwCRMHistoryDetails" runat="server">
                                         <h4><a href='/Admin/ManageCRMRequests.aspx?crmrequestid=<%= CRMCodeRequestID %>' >&lt; Back </a></h4>
                                        <div class="table-header">
