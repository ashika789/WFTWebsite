...
public class DoExpressCheckoutPaymentCommand
{
    // # Static constructor for configuration setting
    static DoExpressCheckoutPaymentCommand()
    {
    ...
    public DoExpressCheckoutPaymentResponseType DoExpressCheckoutPaymentAPIOperation(string strToken, string strPayerID, decimal WFTOrderTotal, string MerchantPayPalEmailID, string WFTOrderNo)
    {
        ...
        try
        {
            ...
            doExpressCheckoutPaymentRequestDetails.Token = strToken;
