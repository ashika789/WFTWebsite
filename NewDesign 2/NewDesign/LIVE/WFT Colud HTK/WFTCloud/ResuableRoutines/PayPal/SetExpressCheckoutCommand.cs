...
public class SetExpressCheckoutCommand
{
    // # Static constructor for configuration setting
    static SetExpressCheckoutCommand()
    {
    ...
    public SetExpressCheckoutResponseType SetExpressCheckoutAPIOperation(string SuccessURL, string CancelURL, decimal WFTOrderTotal, string MerchantPaypalEmailID, string WFTOrderNo,
        string BillingAgrmntDesc
        )
    {
        ...
        try
        {
            ...
            setExpressCheckoutRequestDetails.ReturnURL = SuccessURL;
            ...
            // currencies.
            // * `Amount`
            BasicAmountType orderTotal1 = new BasicAmountType(CurrencyCodeType.USD, WFTOrderTotal.ToString());
            ...
            sellerDetails1.PayPalAccountID = MerchantPaypalEmailID;
            ...
            paymentDetails1.PaymentRequestID = WFTOrderNo;
            ...
            if(!string.IsNullOrEmpty(Address2))
                shipToAddress1.Street2 = Address2;
            shipToAddress1.CityName = AddrCity;
            shipToAddress1.StateOrProvince = AddrState;
            shipToAddress1.Country = CountryCodeType.US;
            shipToAddress1.PostalCode = PostalCode;
            ...
            */
            ...
            // Authorization or Order in SetExpressCheckout, you may set the field
            // to Sale.`
            //paymentDetails2.PaymentAction = PaymentActionCodeType.SALE;

            // Unique identifier for the merchant. For parallel payments, this field
            // is required and must contain the Payer Id or the email address of the
            // merchant.
            //SellerDetailsType sellerDetails2 = new SellerDetailsType();
            //sellerDetails2.PayPalAccountID = "hthirukkumaran-facilitator@gmail.com";
            ...
            */
            ...
            BillingAgreementDetailsType objbadt = new BillingAgreementDetailsType();
            objbadt.BillingAgreementDescription = BillingAgrmntDesc;
            objbadt.BillingType = BillingCodeType.MERCHANTINITIATEDBILLING;
            objbadt.PaymentType = MerchantPullPaymentCodeType.INSTANTONLY;

            List<BillingAgreementDetailsType> lst = new List<BillingAgreementDetailsType>();
            lst.Add(objbadt);

            setExpressCheckoutRequest.SetExpressCheckoutRequestDetails.BillingAgreementDetails = lst;
